...
\REDENDS \author[1]{Yusuke Watanabe\corref{cor1}}
...
\cortext[cor1]{Corresponding author. Tel: +81-6-6879-3652}\REDSTARTS 
% \end{title*}\REDENDS %%Graphical abstract
...
Working memory (WM) is \GREENSTARTS indispensable for numerous\GREENENDS \REDSTARTS crucial for a multitude of\REDENDS  cognitive functions, \GREENSTARTS but the intricate neural mechanisms involved are not full\GREENENDS y\GREENSTARTS  understoo\GREENENDS \REDSTARTS et the intricacies of the neural mechanisms at play remain to be fully comprehende\REDENDS d. \GREENSTARTS T\GREENENDS \REDSTARTS Interestingly, t\REDENDS he hippocampus and sharp-wave ripple complexes (SWRs) --- \GREENSTARTS brief\GREENENDS \REDSTARTS succinct\REDENDS , synchronous neural events in the hippocampus --- \GREENSTARTS attract attention due to their import\GREENENDS \REDSTARTS garner recognition for their signific\REDENDS ance in memory consolidation and retrieval\GREENSTARTS ; however\GREENENDS , \GREENSTARTS their associ\GREENENDS \REDSTARTS albeit their correl\REDENDS ation with WM tasks \GREENSTARTS remains unclear. Our current stud\GREENENDS \REDSTARTS is \REDENDS y\GREENSTARTS  posits that hippocampal multiunit activit\GREENENDS \REDSTARTS et to be clarified. Our current stud\REDENDS y \GREENSTARTS patterns, in conjunction\GREENENDS \REDSTARTS suggests that multiunit activity patterns in the hippocampus may work in tandem\REDENDS  with SWRs, \GREENSTARTS show distinctiv\GREENENDS \REDSTARTS thereby displaying uniqu\REDENDS e dynamics during WM tasks. We \GREENSTARTS analyzed an intracranial electroencephalogram dataset\GREENENDS \REDSTARTS examined a dataset comprising intracranial electroencephalogram recordings\REDENDS  obtained from the medial temporal lobe (MTL) of nine epilepsy patients \GREENSTARTS performing\GREENENDS \REDSTARTS engaged in\REDENDS  an eight-second Sternberg task. \GREENSTARTS Using \GREENENDS Gaussian-process factor analysis\GREENSTARTS ,\GREENENDS  w\GREENSTARTS e derived\GREENENDS \REDSTARTS as employed to extract\REDENDS  low-dimensional neural representations, \GREENSTARTS or\GREENENDS \REDSTARTS termed\REDENDS  'trajectories', within the MTL regions during the WM task. Our \GREENSTARTS results demonstrate that, compared to the entorhinal cort\GREENENDS \REDSTARTS findings indicate that the hippocampus \REDENDS ex\GREENSTARTS  and amygdala, the hippocampus exhibits the most significant\GREENENDS \REDSTARTS hibits the most pronounced\REDENDS  variation in neural trajectory\GREENSTARTS . Moreover, the difference in trajectories bet\GREENENDS \REDSTARTS  in comparison \REDENDS w\GREENSTARTS een encoding and retrieval phases is contingent upon memor\GREENENDS \REDSTARTS ith the entorhinal cortex and am\REDENDS y\GREENSTARTS  load\GREENENDS \REDSTARTS gdala\REDENDS . \GREENSTARTS Notab\GREENENDS \REDSTARTS Moreover, the dissimilarity in trajectories measured between encoding and retrieval phases was found to be contingent on memory load. Significant\REDENDS ly, \REDSTARTS the \REDENDS hippocampal trajectories oscillate during the retrieval phase, \GREENSTARTS indic\GREENENDS \REDSTARTS demonstr\REDENDS ating task-dependent shifts between encoding and retrieval states, both during baseline and SWR events. This \GREENSTARTS oscill\GREENENDS \REDSTARTS fluctu\REDENDS ation transitions from encoding to retrieval states concurrent with\REDSTARTS  the occurrence of\REDENDS  SWRs. \GREENSTARTS Our findings underscore the essenti\GREENENDS \REDSTARTS These discoveries reassert the pivot\REDENDS al role of the hippocampus in WM tasks and propose a \GREENSTARTS new\GREENENDS \REDSTARTS fresh\REDENDS  hypothesis: the hippocampus transition\REDSTARTS s its functional state from encoding to retrieval in the midst of SWRs.
% Working memory (WM) is indispensable for numerous cognitive functions, although the underlying neural mechanisms have not been fully elucidated. While the hippocampus and sharp-wave ripple complexes (SWRs) -- brief, synchronous neural events within the hippocampus -- are acknowledged for their importance in memory consolidation and retrieval, their association with WM tasks remains unclear. The present study posits that hippocampal multiunit activity patterns, in concert with SWRs, manifest distinct dynamics during WM tasks. We analyzed a dataset comprising intracranial electroencephalogram recordings from the medial temporal lobe (MTL) of nine epilepsy patients engaged in an eight-second Sternberg task. Gaussian-process factor analysis was utilized to extract low-dimensional neural representations, or 'trajectories', within MTL regions during the WM task. Our results reveal that the hippocampus demonstrates the most significant fluctuation in neural trajectory relative to the entorhinal cortex and amygdala. Furthermore, trajectories' dissimilarity measured between encoding and retrieval phases is dependent on memory load. Notably, hippocampal trajectories fluctuate during the retrieval phase and exhibit task-dependent shifts between encoding and retrieval states, both during baseline and SWR events. This fluctuation transitions from encoding to retrieval states in the presence of SWRs. These findings reinforce the pivotal role of the hippocampus in WM tasks and suggest a new hypothesis: the hippocampus alter\REDENDS s its functional state from encoding to retrieval during SWRs.
...
%% Additional Information
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\REDENDS \pdfbookmark[1]{Additional Information}{additional_information}
...
\GREENSTARTS %% \pdfbookmark[2]{Appendices}{appendices}                    
%% \appendix
%% \section{}
%% \label{}
