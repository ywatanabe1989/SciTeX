...
# Check the syntax of ./build/main.tex file
chktex -v0 ./build/main.tex > syntax_warnings.log 2>&1

# Format ./build/main.tex file
latexindent -w ./build/main.tex > /dev/null 2>&1
