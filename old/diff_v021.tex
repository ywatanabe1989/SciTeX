...
%DIF DEL ./old/compiled_v020.tex   Sat Jan 13 20:28:04 2024
%DIF ADD ./compiled.tex            Sat Jan 13 20:31:09 2024
...
\midrule
#1 & 4 & ✓ & ✗ & ✓ & ✓ & ✓ & ✗ & ✓ & ✗ & AHR \DIFdelbeginFL \DIFdelFL{\ }%DIFDELCMD < &  %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\& }\DIFaddendFL LR"\\
\rowcolor{lightgray}
#2 & 7 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & AHR \DIFdelbeginFL \DIFdelFL{\ }%DIFDELCMD < &  %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\& }\DIFaddendFL PHR"\\
#3 & 3 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✗ & AHL \DIFdelbeginFL \DIFdelFL{\ }%DIFDELCMD < &  %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\& }\DIFaddendFL PHL"\\
\rowcolor{lightgray}
#4 & 2 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & AHL \DIFdelbeginFL \DIFdelFL{\ }%DIFDELCMD < &  %%%
\DIFdelFL{AHR \ }%DIFDELCMD < &  %%%
\DIFdelFL{PHL \ }%DIFDELCMD < &  %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\& AHR \& PHL \& }\DIFaddendFL PHR\\
#5 & 3 & ✓ & ✗ & ✗ & ✓ & ✗ & ✗ & ✓ & ✗ & DRR\\
\rowcolor{lightgray}
#6 & 6 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & AHL \DIFdelbeginFL \DIFdelFL{\ }%DIFDELCMD < &  %%%
\DIFdelFL{PHL \ }%DIFDELCMD < &  %%%
\DIFdelFL{ECL \ }%DIFDELCMD < &  %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\& PHL \& ECL \& }\DIFaddendFL AL\\
#7 & 4 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & AHR \DIFdelbeginFL \DIFdelFL{\ }%DIFDELCMD < &  %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\& }\DIFaddendFL PHR\\
\rowcolor{lightgray}
#8 & 5 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ECR\\
#9 & 2 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ECR \DIFdelbeginFL \DIFdelFL{\ }%DIFDELCMD < &  %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\& }\DIFaddendFL AR\\
\bottomrule
\end{tabular}
...
\smallskip
\\
This figure denotes the placements of electrodes and seizure onset zones. Regions marked with \DIFdelbeginFL %DIFDELCMD < \cmark %%%
\DIFdelendFL \DIFaddbeginFL \checkmark \DIFaddendFL were included in the dataset, while those imprinted with \DIFdelbeginFL %DIFDELCMD < \xmark %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{x }\DIFaddendFL were absent. The abbreviations used are as follows: AHL, left hippocampal head; AHR, right hippocampal head; PHL, left hippocampal body; PHR, right hippocampal body; ECL, left entorhinal cortex; ECR, right entorhinal cortex; AL, left amygdala; AR, right amygdala; SOZ represents the seizure onset zone.
}
% width=1\textwidth
\label{tab:01}
\end{table*}
