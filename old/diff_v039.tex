...
%DIF DEL ./old/compiled_v038.tex   Sat Jan 13 21:07:06 2024
%DIF ADD ./compiled.tex            Sat Jan 13 21:12:58 2024
...
\DIFdelbegin %DIFDELCMD < \readtablefigurecount
%DIFDELCMD < \readwordcount{./src/.wordcount_abstract.txt} %%%
\DIFdelend %DIF >  \readtablefigurecount
\DIFaddbegin 

\readwordcount{./src/.figure_count.txt} \DIFadd{figures;
}\readwordcount{./src/.table_count.txt} \DIFadd{tables;
}\readwordcount{./src/.abstract_count.txt} \DIFaddend words for Abstract;
\DIFdelbegin %DIFDELCMD < \readwordcount{./src/.wordcount_imrd.txt} %%%
\DIFdelend \DIFaddbegin \readwordcount{./src/.imrd_count.txt} \DIFaddend words for Main Text;\end{frontmatter}
