...
%DIF DEL ./old/compiled_v017.tex   Sat Jan 13 20:16:39 2024
%DIF ADD ./compiled.tex            Sat Jan 13 20:19:55 2024
...
\DIFdelendFL \DIFaddbeginFL \thead{SOZ}\DIFaddendFL } \DIFaddbeginFL &\DIFaddendFL \\
\midrule
1 & 4 & ✓ & ✗ & ✓ & ✓ & ✓ & ✗ & ✓ & ✗ & AHR \& LR \\
\rowcolor{lightgray}
2 & 7 & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & ✓ & AHR \& PHR \\
...
%DIF <  width=1\textwidth\label{tab:01}
%DIF >  width=1\textwidth
\DIFaddbeginFL \label{tab:01}
\DIFaddendFL \end{table*}
%DIF <  \restoregeometry % Uncomment this line if you have changed the geometry before this table.
\DIFaddbegin \restoregeometry\DIFaddend \pdfbookmark[2]{ID 02}{id_02}
\begin{table*}[htbp]
\centering
\small
\begin{tabular}{*{5}{c}}
