...
%DIF DEL ./old/compiled_v062.tex   Sun Jan 14 10:58:51 2024
%DIF ADD ./compiled.tex            Sun Jan 14 11:15:06 2024
...
\end{highlights}\title{
Hippocampal \DIFdelbegin \DIFdel{neural fluctuations between memory encoding }\DIFdelend \DIFaddbegin \DIFadd{Neural Fluctuations Between Memory Encoding }\DIFaddend and \DIFdelbegin \DIFdel{retrieval states during }\DIFdelend \DIFaddbegin \DIFadd{Retrieval States During }\DIFaddend a \DIFdelbegin \DIFdel{working memory task }\DIFdelend \DIFaddbegin \DIFadd{Working Memory Task }\DIFaddend in \DIFdelbegin \DIFdel{humans
}\DIFdelend \DIFaddbegin \DIFadd{Humans
}\DIFaddend }\author[1]{Yusuke Watanabe\corref{cor1}}
...
\\
\indent
\subsection{Statistical \DIFdelbegin \DIFdel{evaluation}\DIFdelend \DIFaddbegin \DIFadd{Evaluation}\DIFaddend }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Results}
\subsection{iEEG \DIFdelbegin \DIFdel{recording }\DIFdelend \DIFaddbegin \DIFadd{Recording }\DIFaddend and NT in MTL \DIFdelbegin \DIFdel{regions }\DIFdelend \DIFaddbegin \DIFadd{Regions }\DIFaddend during the Sternberg \DIFdelbegin \DIFdel{task}\DIFdelend \DIFaddbegin \DIFadd{Task}\DIFaddend }
...
\subsection{\DIFaddbegin \DIFadd{Correlation of }\DIFaddend Hippocampal NT \DIFdelbegin \DIFdel{correlation }\DIFdelend with the Sternberg \DIFdelbegin \DIFdel{task}\DIFdelend \DIFaddbegin \DIFadd{Task}\DIFaddend }
...
\subsection{\DIFdelbegin \DIFdel{Memory-load-dependent }\DIFdelend \DIFaddbegin \DIFadd{Memory-Load-Dependent }\DIFaddend NT \DIFdelbegin \DIFdel{distance }\DIFdelend \DIFaddbegin \DIFadd{Distance }\DIFaddend between \DIFdelbegin \DIFdel{encoding }\DIFdelend \DIFaddbegin \DIFadd{Encoding }\DIFaddend and \DIFdelbegin \DIFdel{retrieval states }\DIFdelend \DIFaddbegin \DIFadd{Retrieval States }\DIFaddend in the \DIFdelbegin \DIFdel{hippocampus}\DIFdelend \DIFaddbegin \DIFadd{Hippocampus}\DIFaddend }
...
\subsection{Detection of \DIFdelbegin \DIFdel{hippocampal SWR }\DIFdelend \DIFaddbegin \DIFadd{Hippocampal SWRs }\DIFaddend from \DIFdelbegin \DIFdel{putative }\DIFdelend \DIFaddbegin \DIFadd{Putative }\DIFaddend CA1 \DIFdelbegin \DIFdel{regions}\DIFdelend \DIFaddbegin \DIFadd{Regions}\DIFaddend }
...
\subsection{Transient \DIFdelbegin \DIFdel{changes }\DIFdelend \DIFaddbegin \DIFadd{Change }\DIFaddend in \DIFdelbegin \DIFdel{hippocampal }\DIFdelend \DIFaddbegin \DIFadd{Hippocampal }\DIFaddend NT during SWR}
...
\subsection{Visualization of \DIFdelbegin \DIFdel{hippocampal }\DIFdelend \DIFaddbegin \DIFadd{Hippocampal }\DIFaddend NT during SWR in \DIFdelbegin \DIFdel{two-dimensional spaces}\DIFdelend \DIFaddbegin \DIFadd{Two-Dimensional Spaces}\DIFaddend }
...
\subsection{Fluctuations of \DIFdelbegin \DIFdel{hippocampal }\DIFdelend \DIFaddbegin \DIFadd{Hippocampal }\DIFaddend NTs between \DIFdelbegin \DIFdel{encoding }\DIFdelend \DIFaddbegin \DIFadd{Encoding }\DIFaddend and \DIFdelbegin \DIFdel{retrieval states}\DIFdelend \DIFaddbegin \DIFadd{Retrieval States}\DIFaddend }
...
\end{tabular}
\captionsetup{width=\textwidth}
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Silhouette score of UMAP clustering for SWR\textsuperscript{+} candidates and SWR\textsuperscript{-} candidates}}
%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Silhouette Score of UMAP Clustering for SWR\textsuperscript{+} Candidates and SWR\textsuperscript{-} Candidates}}
...
\end{tabular}
\captionsetup{width=\textwidth}
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Summary of Detected SWR Events
}}
%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{
\DIFaddFL{Summary of Detected SWRs
}}
\DIFaddendFL \smallskip
\\
...
\smallskip
\\
\textbf{\textit{A.}} Neural trajectories \DIFdelbeginFL \DIFdelFL{are }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(NTs) }\DIFaddendFL depicted as a point cloud within the first three-dimensional factors derived from GPFA \cite{yu_gaussian-process_2009}. The smaller dots represent 50-ms \DIFdelbeginFL \DIFdelFL{neural trajectory }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{NT }\DIFaddendFL bins, and the larger dots with \textit{black} edges denote the geometric medians for each phase in the Sternberg working memory task: fixation ($\mathrm{\lVert g_{F} \rVert}$, \textit{gray}), encoding ($\mathrm{\lVert g_{E} \rVert}$, \textit{blue}), maintenance ($\mathrm{\lVert g_{M} \rVert}$, \textit{green}), and retrieval ($\mathrm{\lVert g_{R} \rVert}$, \textit{red}). \textbf{\textit{B.}} The figure presents the log-likelihood of the GPFA models versus the number of dimensions used to embed multi-unit spikes found in the medial temporal lobe (MTL) regions. Specifically, the elbow method identified three as the optimal dimension. \textbf{\textit{C.}} This panel displays the distance of the \DIFdelbeginFL \DIFdelFL{neural trajectories }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{NTs }\DIFaddendFL from the origin ($O$) for the hippocampus (Hipp.), entorhinal cortex (EC), and amygdala (Amy.), plotted against the time elapsed from the probe onset. \textbf{\textit{D.}} The \DIFdelbeginFL \DIFdelFL{trajectory }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{NT }\DIFaddendFL distance from $O$ within the MTL regions is shown. The hippocampus has the greatest distance, followed by the EC and the Amygdala. \textbf{\textit{E.}} The box plot illustrates inter-phase \DIFdelbeginFL \DIFdelFL{trajectory }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{NT }\DIFaddendFL distances within the MTL regions.
}
% width=0.5\textwidth
        	\label{fig:02}
        \end{figure*}
        ...
        \begin{figure*}[ht]
        	...
        	\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Relationship between Trajectory Distance and Memory Load: States of Encoding and Retrieval in the Hippocampus
}}
%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{
\DIFaddFL{Relationship between Neural Trajectory Distance and Memory Load: States of Encoding and Retrieval in the Hippocampus
}}
\DIFaddendFL \smallskip
\\
\textbf{\textit{A.}} \DIFdelbeginFL \DIFdelFL{Demonstrates the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The }\DIFaddendFL relationship between set size (number of letters to be encoded) and accuracy in the working memory task (coefficient = $-0.20$, ***\textit{p} $<$ 0.001). \textbf{\textit{B.}} \DIFdelbeginFL \DIFdelFL{Displays the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The }\DIFaddendFL correlation between set size and response time (coefficient = 0.23, ***\textit{p} $<$ 0.001). \textbf{\textit{C.}} \DIFdelbeginFL \DIFdelFL{Exhibits the influence of }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The correlation between }\DIFaddendFL set size on the inter-phase distances between the encoding and retrieval phases ($\lVert \mathrm{g_{E}g_{R}} \rVert$) (correlation coefficient = 0.05, ***\textit{p} $<$ 0.001). \textbf{\textit{D.}} \DIFdelbeginFL \DIFdelFL{Indicates experimental }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Experimental }\DIFaddendFL observations of correlations between set size and the following parameters: accuracy, response time, $\log_{10}{\lVert \mathrm{g_{F}g_{E}} \rVert}$, $\log_{10}{\lVert \mathrm{g_{F}g_{M}} \rVert}$, $\log_{10}{\lVert \mathrm{g_{F}g_{R}} \rVert}$, $\log_{10}{\lVert \mathrm{g_{E}g_{M}} \rVert}$, $\log_{10}{\lVert \mathrm{g_{E}g_{R}} \rVert}$, and $\log_{10}{\lVert \mathrm{g_{M}g_{R}} \rVert}$ represented by \textit{red} dots. The \DIFdelbeginFL \textit{\DIFdelFL{gray}} %DIFAUXCMD
\DIFdelendFL kernel density plots \DIFaddbeginFL \DIFaddFL{(}\textit{\DIFaddFL{gray}}\DIFaddFL{) }\DIFaddendFL illustrate the corresponding shuffled surrogate with set size (\textit{n} = 1,000) (***\textit{p}s $<$ 0.001).
}
% width=1\textwidth
        	\label{fig:03}
        \end{figure*}
...
% width=1\textwidth
        ...
        \begin{figure*}[ht]
        	...
        	\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Transient Changes in Neural Pathway During SWR Events}}
%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Transient Changes in Neural Trajectory During SWR Events}}
\DIFaddendFL \smallskip
\\
\textbf{\textit{A.}} \DIFdelbeginFL \DIFdelFL{Presented is the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The }\DIFaddendFL distance from origin ($O$) of the peri-sharp-wave-ripple \DIFdelbeginFL \DIFdelFL{pathway }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{neural trajectory }\DIFaddendFL (mean \textpm 95\% confidence interval). The intervals may be obscured due to their minimal ranges. \textbf{\textit{B.}} The distance from the origin ($O$) during the pre-, mid-, and post-SWR periods is demonstrated (*\textit{p} $<$ 0.05, **\textit{p} $<$ 0.01, ***\textit{p} $<$ 0.001; Brunner--Munzel test applied). Abbreviations: SWR, sharp-wave ripple events; eSWR, SWR during the encoding phase; rSWR, SWR within the retrieval phase; SWR$^+$, positive SWR event; SWR$^-$, control events for SWR$^+$; pre-, mid-, or post-SWR refer to the time intervals from $-800$ to $-250$ ms, from $-250$ to $+250$ ms, or from $+250$ to $+800$ ms, respectively, all relative to the SWR center.}
% width=1\textwidth
        	\label{fig:05}
        \end{figure*}
        \clearpage
...
\smallskip
\\
\textbf{\textit{A--B}} \DIFdelbeginFL \DIFdelFL{Shows the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The }\DIFaddendFL kernel density estimation distributions of $\protect\overrightarrow{{\mathrm{eSWR^+}}}$ $\cdot$ $\protect\overrightarrow{{\mathrm{rSWR^+}}}$ (depicted as pink circles), $\protect\overrightarrow{{\mathrm{eSWR^+}}}$ $\cdot$ $\protect\overrightarrow{{\mathrm{g_{E}g_{R}}}}$ (blue triangles), and $\protect\overrightarrow{{\mathrm{rSWR^+}}}$ $\cdot$ $\protect\overrightarrow{{\mathrm{g_{E}g_{R}}}}$ (\DIFdelbeginFL \DIFdelFL{red rectangles}\DIFdelendFL \DIFaddbeginFL \textit{\DIFaddFL{red rectangles}}\DIFaddendFL ) in the Match In (\textit{A}) and Mismatch OUT tasks (\textit{B}). \textbf{\textit{C--D}} Illustrates the corresponding distributions of $\mathrm{SWR^-}$ instead of those of $\mathrm{SWR^+}$ in \textit{A} and \textit{B}. \textbf{\textit{E--F}} \DIFdelbeginFL \DIFdelFL{Renders the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The }\DIFaddendFL differences in the distributions of $\mathrm{SWR^+}$ and $\mathrm{SWR^-}$, detailing the SWR components (\textit{E} = \textit{C} - \textit{A} & \textit{F} = \textit{D} - \textit{B}). The biphasic distributions of $\protect\overrightarrow{{\mathrm{rSWR^-}}}$ $\cdot$ $\protect\overrightarrow{{\mathrm{g_{E}g_{R}}}}$ indicates fluctuations between the encoding and retrieval states during the Sternberg task. Also, contradicting directionality between $\protect\overrightarrow{{\mathrm{eSWR^+}}}$ and $\protect\overrightarrow{{\mathrm{rSWR^+}}}$ was observed (pink circles) not in Match IN task (\textbf{\textit{E}}), but in Mismatch OUT task (\textbf{\textit{F}}). Lastly, transition from the retrieval to encoding states are apparent in the SWR components in both Match IN and Mismatch OUT tasks (red rectangles in \textit{E--F}).
}
% width=0.5\textwidth
        	\label{fig:07}
        \end{figure*}
