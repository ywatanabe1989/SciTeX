...
%DIF DEL ./old/compiled_v036.tex   Sat Jan 13 20:49:57 2024
%DIF ADD ./compiled.tex            Sat Jan 13 21:05:05 2024
...
%DIF >  Use these commands where you want to display the counts
\readtablefigurecount
\readwordcount{./src/.wordcount_abstract.txt} \DIFadd{words for Abstract;
}\readwordcount{./src/.wordcount_imrd.txt} \DIFadd{words for Main Text;}\DIFaddend \end{frontmatter}
...
\begin{tabular}{*{6}{c}}
\toprule
\textbf{\thead{Subject ID}} &\textbf{\thead{\# of sessions}} &\textbf{\DIFdelbeginFL %DIFDELCMD < \thead{# of trials}%%%
\DIFdelendFL \DIFaddbeginFL \thead{\# of trials}\DIFaddendFL } &\textbf{\thead{ROI}} &\textbf{\DIFdelbeginFL %DIFDELCMD < \thead{# of SWRs}%%%
\DIFdelendFL \DIFaddbeginFL \thead{\# of SWRs}\DIFaddendFL } &\textbf{\thead{SWR incidence [Hz]}} &\\
\midrule
