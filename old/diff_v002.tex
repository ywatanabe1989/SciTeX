...
%DIF DEL ./old/compiled_v001.tex   Sat Jan 13 16:36:32 2024
%DIF ADD ./compiled.tex            Sat Jan 13 16:39:22 2024
...
Working memory (WM) \DIFdelbegin \DIFdel{forms a crucial foundation for }\DIFdelend \DIFaddbegin \DIFadd{serves as a critical cornerstone in }\DIFaddend a multitude of cognitive functions\DIFdelbegin \DIFdel{, yetthe complex neural mechanisms underlying its operation are not fully understood. More specifically, while }\DIFdelend \DIFaddbegin \DIFadd{; yet, the elaborate neural mechanisms underpinning its functionality remain incompletely understood. Specifically, while both }\DIFaddend the hippocampus and sharp-wave ripple complexes (SWRs) --- rapid, coordinated \DIFdelbegin \DIFdel{neuronal activities }\DIFdelend \DIFaddbegin \DIFadd{neural occurrences }\DIFaddend within the hippocampus --- are \DIFdelbegin \DIFdel{known to play }\DIFdelend \DIFaddbegin \DIFadd{recognized for their }\DIFaddend roles in memory consolidation and retrieval, their \DIFdelbegin \DIFdel{contribution to WM tasks remains somewhat ambiguous. Our current research suggests }\DIFdelend \DIFaddbegin \DIFadd{involvement in WM tasks persists as somewhat equivocal. Our present research theorizes }\DIFaddend that the multiunit activity patterns \DIFdelbegin \DIFdel{in the hippocampus operate in synergy }\DIFdelend \DIFaddbegin \DIFadd{within the hippocampus work synergistically }\DIFaddend with SWRs, \DIFdelbegin \DIFdel{exhibiting distinguishable dynamics }\DIFdelend \DIFaddbegin \DIFadd{thereby demonstrating distinctive dynamism }\DIFaddend during WM tasks. \DIFdelbegin \DIFdel{We conducted a comprehensive }\DIFdelend \DIFaddbegin \DIFadd{Our investigation involved an in-depth }\DIFaddend analysis of a dataset derived from intracranial electroencephalogram recordings \DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{acquired from }\DIFaddend the medial temporal lobe (MTL) \DIFdelbegin \DIFdel{from nine epilepsy patients }\DIFdelend \DIFaddbegin \DIFadd{of nine individuals with epilepsy }\DIFaddend performing an eight-second Sternberg task. We \DIFdelbegin \DIFdel{utilized }\DIFdelend \DIFaddbegin \DIFadd{employed }\DIFaddend Gaussian-process factor analysis to \DIFdelbegin \DIFdel{identify }\DIFdelend \DIFaddbegin \DIFadd{discern }\DIFaddend low-dimensional \DIFdelbegin \DIFdel{neuronal }\DIFdelend \DIFaddbegin \DIFadd{neural }\DIFaddend representations, or 'trajectories,' within the MTL \DIFdelbegin \DIFdel{regions }\DIFdelend \DIFaddbegin \DIFadd{territories }\DIFaddend during the WM task. Our \DIFdelbegin \DIFdel{data showed that the neuronal trajectory varied most significantly }\DIFdelend \DIFaddbegin \DIFadd{findings revealed that the neural trajectory exhibited the most significant variations }\DIFaddend in the hippocampus \DIFaddbegin \DIFadd{when }\DIFaddend compared to the entorhinal cortex and amygdala. \DIFdelbegin \DIFdel{Furthermore, variations }\DIFdelend \DIFaddbegin \DIFadd{Moreover, divergence }\DIFaddend in the trajectories \DIFdelbegin \DIFdel{between the }\DIFdelend \DIFaddbegin \DIFadd{identified between }\DIFaddend encoding and retrieval phases were \DIFdelbegin \DIFdel{dependent on memory load. Notably}\DIFdelend \DIFaddbegin \DIFadd{memory load-dependent. Importantly}\DIFaddend , hippocampal trajectories oscillated during the retrieval phase, \DIFdelbegin \DIFdel{showcasing }\DIFdelend \DIFaddbegin \DIFadd{displaying }\DIFaddend task-dependent transitions between encoding and retrieval states, \DIFdelbegin \DIFdel{including }\DIFdelend \DIFaddbegin \DIFadd{inclusive of }\DIFaddend baseline and SWR \DIFdelbegin \DIFdel{periods}\DIFdelend \DIFaddbegin \DIFadd{episodes}\DIFaddend . These oscillations \DIFdelbegin \DIFdel{transitioned }\DIFdelend \DIFaddbegin \DIFadd{shifted }\DIFaddend from encoding to retrieval states \DIFdelbegin \DIFdel{aligned }\DIFdelend \DIFaddbegin \DIFadd{in accordance }\DIFaddend with SWRs. \DIFdelbegin \DIFdel{Thus, our findings emphasize the vital }\DIFdelend \DIFaddbegin \DIFadd{Hence, these results highlight the critical }\DIFaddend role of the hippocampus in \DIFdelbegin \DIFdel{carrying out }\DIFdelend \DIFaddbegin \DIFadd{performing }\DIFaddend WM tasks and propose a \DIFdelbegin \DIFdel{compelling hypothesis for future }\DIFdelend \DIFaddbegin \DIFadd{persuasive hypothesis for subsequent }\DIFaddend investigation: the functional state of the hippocampus transitions from encoding to retrieval during SWRs.
