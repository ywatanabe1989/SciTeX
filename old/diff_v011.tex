...
%DIF DEL ./old/compiled_v010.tex   Sat Jan 13 17:04:43 2024
%DIF ADD ./compiled.tex            Sat Jan 13 17:26:43 2024
...
Working memory (WM) \DIFdelbegin \DIFdel{serves as a critical cornerstone in a multitude of cognitive functions; yet, the elaborate neural mechanisms underpinning its functionality remain incompletely understood. Specifically, while both }\DIFdelend \DIFaddbegin \DIFadd{is a vital component in numerous cognitive functions, yet the complex neural mechanisms that sustain its operation are not fully understood. In particular, while }\DIFaddend the hippocampus and sharp-wave ripple complexes (SWRs) --- \DIFdelbegin \DIFdel{rapid}\DIFdelend \DIFaddbegin \DIFadd{brief}\DIFaddend , coordinated neural \DIFdelbegin \DIFdel{occurrences }\DIFdelend \DIFaddbegin \DIFadd{events }\DIFaddend within the hippocampus --- are \DIFdelbegin \DIFdel{recognized }\DIFdelend \DIFaddbegin \DIFadd{known }\DIFaddend for their roles in memory consolidation and retrieval, their \DIFdelbegin \DIFdel{involvement }\DIFdelend \DIFaddbegin \DIFadd{engagement }\DIFaddend in WM tasks \DIFdelbegin \DIFdel{persists as somewhat equivocal. Our present research theorizes }\DIFdelend \DIFaddbegin \DIFadd{remains unclear. Our current research posits }\DIFaddend that the multiunit activity patterns \DIFdelbegin \DIFdel{within the hippocampus work synergistically }\DIFdelend \DIFaddbegin \DIFadd{in the hippocampus collaborate }\DIFaddend with SWRs, \DIFdelbegin \DIFdel{thereby demonstrating distinctive }\DIFdelend \DIFaddbegin \DIFadd{showing unique }\DIFaddend dynamism during WM tasks. Our \DIFdelbegin \DIFdel{investigation involved an in-depth }\DIFdelend \DIFaddbegin \DIFadd{study involved the }\DIFaddend analysis of a dataset \DIFdelbegin \DIFdel{derived }\DIFdelend \DIFaddbegin \DIFadd{obtained }\DIFaddend from intracranial electroencephalogram recordings \DIFdelbegin \DIFdel{acquired }\DIFdelend \DIFaddbegin \DIFadd{procured }\DIFaddend from the medial temporal lobe (MTL) of nine individuals with epilepsy performing an eight-second Sternberg task. We \DIFdelbegin \DIFdel{employed }\DIFdelend \DIFaddbegin \DIFadd{utilized }\DIFaddend Gaussian-process factor analysis to discern low-dimensional neural representations, or 'trajectories,' within the MTL \DIFdelbegin \DIFdel{territories }\DIFdelend \DIFaddbegin \DIFadd{regions }\DIFaddend during the WM task. Our \DIFdelbegin \DIFdel{findings }\DIFdelend \DIFaddbegin \DIFadd{results }\DIFaddend revealed that the neural \DIFdelbegin \DIFdel{trajectory exhibited the most significant }\DIFdelend \DIFaddbegin \DIFadd{trajectories showed the most pronounced }\DIFaddend variations in the hippocampus \DIFdelbegin \DIFdel{when }\DIFdelend compared to the entorhinal cortex and amygdala. \DIFdelbegin \DIFdel{Moreover, divergence }\DIFdelend \DIFaddbegin \DIFadd{Furthermore, differences }\DIFaddend in the trajectories \DIFdelbegin \DIFdel{identified }\DIFdelend between encoding and retrieval phases were \DIFdelbegin \DIFdel{memory load-dependent. Importantly}\DIFdelend \DIFaddbegin \DIFadd{dependent on memory load. Crucially}\DIFaddend , hippocampal trajectories oscillated during the retrieval phase, \DIFdelbegin \DIFdel{displaying }\DIFdelend \DIFaddbegin \DIFadd{illustrating }\DIFaddend task-dependent transitions between encoding and retrieval \DIFdelbegin \DIFdel{states, inclusive of }\DIFdelend \DIFaddbegin \DIFadd{stages, which include }\DIFaddend baseline and SWR episodes. These oscillations \DIFdelbegin \DIFdel{shifted }\DIFdelend \DIFaddbegin \DIFadd{transitioned }\DIFaddend from encoding to retrieval states in accordance with SWRs. \DIFdelbegin \DIFdel{Hence, these results highlight the critical }\DIFdelend \DIFaddbegin \DIFadd{Therefore, these outcomes demonstrate the integral }\DIFaddend role of the hippocampus in \DIFdelbegin \DIFdel{performing }\DIFdelend \DIFaddbegin \DIFadd{executing }\DIFaddend WM tasks and \DIFdelbegin \DIFdel{propose a persuasive hypothesis for subsequent }\DIFdelend \DIFaddbegin \DIFadd{put forth a compelling hypothesis for further }\DIFaddend investigation: the \DIFdelbegin \DIFdel{functional }\DIFdelend \DIFaddbegin \DIFadd{operational }\DIFaddend state of the hippocampus \DIFdelbegin \DIFdel{transitions }\DIFdelend \DIFaddbegin \DIFadd{shifts }\DIFaddend from encoding to retrieval during SWRs.
