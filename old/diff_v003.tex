...
%DIF DEL ./old/compiled_v002.tex   Sat Jan 13 16:39:35 2024
%DIF ADD ./compiled.tex            Sat Jan 13 16:39:59 2024
...
\DIFdelbegin \DIFdel{Working }\DIFdelend \DIFaddbegin \DIFadd{The working }\DIFaddend memory (WM)\DIFdelbegin \DIFdel{serves as a critical cornerstone in a multitude of cognitive functions; yet, the elaborate neural mechanisms underpinning its functionality remain incompletely }\DIFdelend \DIFaddbegin \DIFadd{, a cornerstone of many cognitive functions, holds complex neural mechanisms that are not yet entirely }\DIFaddend understood. Specifically, \DIFdelbegin \DIFdel{while both }\DIFdelend \DIFaddbegin \DIFadd{the involvement of }\DIFaddend the hippocampus and sharp-wave ripple complexes (SWRs) \DIFdelbegin \DIFdel{--- rapid, coordinated neural occurrences }\DIFdelend \DIFaddbegin \DIFadd{-- rapid, coincident neural events }\DIFaddend within the hippocampus \DIFdelbegin \DIFdel{--- are recognized for their }\DIFdelend \DIFaddbegin \DIFadd{-- in WM tasks remains somewhat uncertain, despite their established }\DIFaddend roles in memory consolidation and retrieval\DIFdelbegin \DIFdel{, their involvement in WM tasks persists as somewhat equivocal. Our present researchtheorizes that the }\DIFdelend \DIFaddbegin \DIFadd{. In our current research, we propose that }\DIFaddend multiunit activity patterns within the hippocampus \DIFdelbegin \DIFdel{work }\DIFdelend \DIFaddbegin \DIFadd{interact }\DIFaddend synergistically with SWRs, thereby \DIFdelbegin \DIFdel{demonstrating distinctive dynamism }\DIFdelend \DIFaddbegin \DIFadd{displaying unique dynamics }\DIFaddend during WM tasks. \DIFdelbegin \DIFdel{Our investigation involved an in-depth }\DIFdelend \DIFaddbegin \DIFadd{This study involved an extensive }\DIFaddend analysis of a dataset \DIFdelbegin \DIFdel{derived }\DIFdelend \DIFaddbegin \DIFadd{obtained }\DIFaddend from intracranial electroencephalogram recordings \DIFdelbegin \DIFdel{acquired }\DIFdelend from the medial temporal lobe (MTL) of nine \DIFdelbegin \DIFdel{individuals with epilepsy}\DIFdelend \DIFaddbegin \DIFadd{patients with epilepsy, while }\DIFaddend performing an eight-second Sternberg task. \DIFdelbegin \DIFdel{We employed }\DIFdelend Gaussian-process factor analysis \DIFdelbegin \DIFdel{to discern }\DIFdelend \DIFaddbegin \DIFadd{was employed to identify }\DIFaddend low-dimensional neural representations, or 'trajectories,' within the MTL \DIFdelbegin \DIFdel{territories }\DIFdelend during the WM task. \DIFdelbegin \DIFdel{Our findings revealed that the neural trajectory }\DIFdelend \DIFaddbegin \DIFadd{We found that the hippocampus }\DIFaddend exhibited the most significant variations in \DIFdelbegin \DIFdel{the hippocampus when }\DIFdelend \DIFaddbegin \DIFadd{neural trajectories }\DIFaddend compared to the entorhinal cortex and \DIFdelbegin \DIFdel{amygdala. Moreover, divergence in the trajectories identified }\DIFdelend \DIFaddbegin \DIFadd{the amygdala. Interestingly, the divergence in trajectories }\DIFaddend between encoding and retrieval phases \DIFdelbegin \DIFdel{were }\DIFdelend \DIFaddbegin \DIFadd{was }\DIFaddend memory load-dependent. \DIFdelbegin \DIFdel{Importantly}\DIFdelend \DIFaddbegin \DIFadd{More specifically}\DIFaddend , hippocampal trajectories oscillated during the retrieval phase, \DIFdelbegin \DIFdel{displaying }\DIFdelend \DIFaddbegin \DIFadd{revealing }\DIFaddend task-dependent transitions between encoding and retrieval states, \DIFdelbegin \DIFdel{inclusive of }\DIFdelend \DIFaddbegin \DIFadd{encapsulating }\DIFaddend baseline and SWR episodes. These oscillations \DIFdelbegin \DIFdel{shifted }\DIFdelend \DIFaddbegin \DIFadd{moved }\DIFaddend from encoding to retrieval states \DIFdelbegin \DIFdel{in accordance with SWRs. Hence, these results highlight the critical }\DIFdelend \DIFaddbegin \DIFadd{correlating with the SWRs. Therefore, these findings emphasize the essential }\DIFaddend role of the hippocampus in performing WM tasks and \DIFdelbegin \DIFdel{propose a persuasive hypothesis for subsequent }\DIFdelend \DIFaddbegin \DIFadd{suggest a compelling premise for further }\DIFaddend investigation: the functional state of the hippocampus transitions from encoding to retrieval during SWRs.
