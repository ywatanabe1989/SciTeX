...
%DIF DEL ./old/compiled_v042.tex   Sat Jan 13 21:20:27 2024
%DIF ADD ./compiled.tex            Sat Jan 13 21:24:25 2024
...
%DIF <   \openin\wordcount=./src/.n_tables_and_figures.txt
%DIF <   \read\wordcount to \thetablefigurecount
%DIF <   \closein\wordcount
%DIF <   \thetablefigurecount
%DIF < }
%DIF < 
%DIF -------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\DIFaddend \readwordcount{./src/.figure_count.txt} figures\DIFdelbegin \DIFdel{;
}\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend \readwordcount{./src/.table_count.txt} tables\DIFdelbegin \DIFdel{;
}\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend \readwordcount{./src/.abstract_count.txt} words for \DIFdelbegin \DIFdel{Abstract;
}\DIFdelend \DIFaddbegin \DIFadd{abstract, and }\DIFaddend \readwordcount{./src/.imrd_count.txt} words for \DIFdelbegin \DIFdel{Main Text;
}%DIFDELCMD < \end{wordcount}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{tain text
}\end{wordcount*}
\DIFaddend %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% IMRaD
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
