...
%DIF DEL ./old/compiled_v039.tex   Sat Jan 13 21:13:11 2024
%DIF ADD ./compiled.tex            Sat Jan 13 21:14:58 2024
...
%DIF <  \readtablefigurecount
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{wordcount*}
\DIFaddend \readwordcount{./src/.figure_count.txt} figures;
\readwordcount{./src/.table_count.txt} tables;
\readwordcount{./src/.abstract_count.txt} words for Abstract;
\readwordcount{./src/.imrd_count.txt} words for Main Text;
\DIFaddbegin \end{wordcount*}\DIFaddend \end{frontmatter}
