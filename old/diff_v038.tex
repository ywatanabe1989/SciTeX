...
%DIF DEL ./old/compiled_v037.tex   Sat Jan 13 21:05:19 2024
%DIF ADD ./compiled.tex            Sat Jan 13 21:06:53 2024
...
\newcommand\readwordcount[1]{% %DIF > 
 ...
 %DIF > 
% Command to read table and figure counts %DIF > 
\newcommand\readtablefigurecount{% %DIF > 
  \openin\wordcount=./src/.n_tables_and_figures.txt %DIF > 
  \read\wordcount to \thetablefigurecount %DIF > 
  \closein\wordcount %DIF > 
  \thetablefigurecount %DIF > 
} %DIF > 
 %DIF > 
%DIF -------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%DIFDELCMD <   \openin\wordcount=#1
%DIFDELCMD <   \read\wordcount to \thewordcount
%DIFDELCMD <   \closein\wordcount
%DIFDELCMD <   \thewordcount
%DIFDELCMD < }
%DIFDELCMD < 

%DIFDELCMD < %%%
%DIF <  Command to read table and figure counts
%DIFDELCMD < \newcommand\readtablefigurecount{%
%DIFDELCMD <   \openin\wordcount=./src/.n_tables_and_figures.txt
%DIFDELCMD <   \read\wordcount to \thetablefigurecount
%DIFDELCMD <   \closein\wordcount
%DIFDELCMD <   \thetablefigurecount
%DIFDELCMD < }
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend % Use these commands where you want to display the counts
\readtablefigurecount
\readwordcount{./src/.wordcount_abstract.txt} words for Abstract;
\readwordcount{./src/.wordcount_imrd.txt} words for Main Text;\end{frontmatter}
