...
%DIF DEL ./old/compiled_v046.tex   Sat Jan 13 22:52:29 2024
%DIF ADD ./compiled.tex            Sun Jan 14 07:51:10 2024
...
Working memory (WM) \DIFdelbegin \DIFdel{plays a critical role in various }\DIFdelend \DIFaddbegin \DIFadd{is crucial for a multitude of cognitive }\DIFaddend cognitive functions, but \DIFdelbegin \DIFdel{the intricate neural mechanisms that support its operation remain elusive. Specifically, while }\DIFdelend \DIFaddbegin \DIFadd{its underlying neural mechanisms at play remain to be fully understood. Interestingly, }\DIFaddend the hippocampus and sharp-wave ripple complexes (SWRs) \DIFdelbegin \DIFdel{-- brief, synchronous neural }\DIFdelend \DIFaddbegin \DIFadd{--- transient and synchronous }\DIFaddend oscillation observed in the hippocampus \DIFdelbegin \DIFdel{-- are recognized for their roles }\DIFdelend \DIFaddbegin \DIFadd{--- garner recognition for their significance }\DIFaddend in memory consolidation and retrieval, \DIFdelbegin \DIFdel{their involvement in WM tasks has not yet been defined}\DIFdelend \DIFaddbegin \DIFadd{albeit their correlation with WM tasks remains to be elucidated}\DIFaddend . Here we show that during a WM task, multiunit activity patterns in the hippocampus display distinctive dynamics, \DIFdelbegin \DIFdel{particularly }\DIFdelend \DIFaddbegin \DIFadd{esprcially }\DIFaddend during SWR periods. This study analyzed \DIFdelbegin \DIFdel{a dataset derived from intracranial electroencephalogram recordings conducted in }\DIFdelend \DIFaddbegin \DIFadd{intracranial electroencephalography data from }\DIFaddend the medial temporal lobe (MTL) of nine \DIFdelbegin \DIFdel{individuals with epilepsy}\DIFdelend \DIFaddbegin \DIFadd{patients with epilepsy, recorded }\DIFaddend during an eight-second Sternberg task. \DIFdelbegin \DIFdel{We applied }\DIFdelend \DIFaddbegin \DIFadd{Utilizing }\DIFaddend Gaussian-process factor analysis\DIFdelbegin \DIFdel{to determine }\DIFdelend \DIFaddbegin \DIFadd{, we extracted }\DIFaddend low-dimensional neural representations \DIFdelbegin \DIFdel{, or 'trajectories,' within the MTL regions while performing }\DIFdelend \DIFaddbegin \DIFadd{or ’trajectories’ within MTL regions during }\DIFaddend the WM task. The results revealed significant variations in \DIFdelbegin \DIFdel{the hippocampus' neural trajectories }\DIFdelend \DIFaddbegin \DIFadd{neural trajectories of the hippocampus }\DIFaddend compared to those \DIFdelbegin \DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend the entorhinal cortex and \DIFaddbegin \DIFadd{the }\DIFaddend amygdala. Additionally, the distance of the trajectory between the encoding and retrieval phases was dependent on memory load. \DIFdelbegin \DIFdel{Importantly}\DIFdelend \DIFaddbegin \DIFadd{Crucially}\DIFaddend , hippocampal trajectories \DIFaddbegin \DIFadd{oscillated }\DIFaddend during the retrieval phase \DIFdelbegin \DIFdel{demonstrated fluctuations }\DIFdelend between encoding and retrieval \DIFdelbegin \DIFdel{stages based on task type, particularly showing transient shift }\DIFdelend \DIFaddbegin \DIFadd{states in a task-dependent manner. Notably, these fluctuations shifted }\DIFaddend from encoding to retrieval states during \DIFdelbegin \DIFdel{SWRs}\DIFdelend \DIFaddbegin \DIFadd{SWR episodes}\DIFaddend . These findings \DIFdelbegin \DIFdel{underline the hippocampus 's essential function in performing }\DIFdelend \DIFaddbegin \DIFadd{reaffirm the role of the hippocampus in }\DIFaddend WM tasks and propose a hypothesis\DIFdelbegin \DIFdel{for future research: the functional state of the hippocampus transition }\DIFdelend \DIFaddbegin \DIFadd{: the hippocampus transitions its functional state }\DIFaddend from encoding to retrieval during SWRs \DIFaddbegin \DIFadd{in WM tasks}\DIFaddend .
\end{abstract}
\DIFaddbegin 

\DIFaddend % \pdfbookmark[1]{Keywords}{keywords}                
\begin{keyword}
