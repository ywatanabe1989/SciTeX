...
%DIF DEL ./old/compiled_v047.tex   Sun Jan 14 07:51:24 2024
%DIF ADD ./compiled.tex            Sun Jan 14 08:28:53 2024
...
Working memory (WM) \DIFdelbegin \DIFdel{significantly influences everyday life, and the neural bases of this cognitive process continue to be the subject of intensive research. One key focus of this research is }\DIFdelend \DIFaddbegin \DIFadd{is crucial in everyday life; however, its neural mechanism has yet to be fully elucidated. Specifically, the role of }\DIFaddend the hippocampus, \DIFdelbegin \DIFdel{a structure integral to memory functions }\DIFdelend \DIFaddbegin \DIFadd{an essential brain region contributing to memory has been an ongoing topic }\DIFaddend \cite{scoville_loss_1957} \cite{squire_legacy_2009}  \cite{boran_persistent_2019} \cite{kaminski_persistently_2017} \cite{kornblith_persistent_2017} \cite{faraut_dataset_2018} \cite{borders_hippocampus_2022} \cite{li_functional_2023} \cite{dimakopoulos_information_2022}. \DIFdelbegin \DIFdel{A deeper understanding of the hippocampus's }\DIFdelend \DIFaddbegin \DIFadd{Understanding the hippocampus’ }\DIFaddend role in working memory is \DIFdelbegin \DIFdel{not only crucial for advancing our knowledge but also }\DIFdelend \DIFaddbegin \DIFadd{instrumental in deepening our knowledge of cognitive processes and }\DIFaddend potentially for enhancing cognitive abilities.
\DIFaddbegin 
