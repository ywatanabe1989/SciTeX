...
%DIF DEL ./old/compiled_v041.tex   Sat Jan 13 21:19:11 2024
%DIF ADD ./compiled.tex            Sat Jan 13 21:20:14 2024
...
%DIF > % Counters
%DIF > %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\DIFaddend \begin{wordcount}
\readwordcount{./src/.figure_count.txt} figures;
...
\end{wordcount}
\DIFdelbegin %DIFDELCMD < \end{frontmatter}
%DIFDELCMD < 
