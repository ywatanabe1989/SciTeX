...
% width=0.5\textwidth
        ...
        \begin{figure*}[ht]
        	...
        	\caption{\textbf{
Relationship between Neural Trajectory Distance and Memory Load: States of Encoding and Retrieval in the Hippocampus
}
\smallskip
\\
...
% width=1\textwidth
        ...
        \begin{figure*}[ht]
        	...
        	\caption{\textbf{Transient Changes in Neural Trajectory During SWR Events}
\smallskip
\\
